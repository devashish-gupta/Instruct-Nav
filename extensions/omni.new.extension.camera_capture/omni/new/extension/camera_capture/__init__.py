...
class OmniNewExtensionCamera_captureExtension(omni.ext.IExt):
    ...
    def on_startup(self, ext_id):
        print("[omni.new.extension.camera_capture] OmniNewExtensionCamera_captureExtension startup", flush=True)

    def on_shutdown(self):
        print("[omni.new.extension.camera_capture] OmniNewExtensionCamera_captureExtension shutdown", flush=True)
